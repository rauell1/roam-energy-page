...
const PRODUCTS = [
  {
    id: 'jinko-400w',
    brand: 'Jinko',
    name: 'JinkoSolar Tiger Neo 400W',
    category: 'Solar Panel',
    price: 22500,
    image: null,
    description: 'High-efficiency monocrystalline panel ideal for rooftop installations. Excellent low-light performance.',
    specs: {
      'Wattage': '400 W',
      'Cell Type': 'Mono PERC',
      'Efficiency': '21.3 %',
  ...
  },
  {
    id: 'jinko-550w',
    brand: 'Jinko',
    name: 'JinkoSolar Tiger Neo 550W',
    category: 'Solar Panel',
    price: 28500,
    image: null,
    description: 'Larger format panel for commercial and ground-mount applications with a lower cost per watt.',
    specs: {
      'Wattage': '550 W',
      'Cell Type': 'Mono PERC',
      'Efficiency': '21.8 %',
  ...
  },
  {
    ...
    price: 95000,
    image: 'Deye A.jpg',
    description: 'All-in-one hybrid inverter that works on-grid, off-grid, or with battery backup seamlessly.',
    specs: {
      'Rated Power': '5 kW',
  ...
  },
  {
    id: 'deye-8kw',
    brand: 'Deye',
    name: 'Deye 8 kW Hybrid Inverter',
    category: 'Inverter',
    price: 140000,
    image: 'Deye A.jpg',
    description: 'Higher-power hybrid inverter suitable for larger homes and small businesses.',
    specs: {
      'Rated Power': '8 kW',
      'Type': 'Hybrid (Grid-Tie + Battery)',
      'MPPT Channels': '2',
  ...
  },
  {
    id: 'dyness-5kw',
    brand: 'Dyness',
    name: 'Dyness B4850 5.12 kWh Battery',
    category: 'Battery',
    price: 120000,
    image: 'Dyness A.jpg',
    description: 'Safe, stackable lithium iron phosphate battery module. Up to 15 units can be connected in parallel.',
    specs: {
      'Capacity': '5.12 kWh',
      'Chemistry': 'LiFePO₄',
      'Voltage': '48 V / 100 Ah',
  ...
  },
  {
    ...
    price: 215000,
    image: 'Dyness.png',
    description: 'Wall-mounted all-in-one energy storage unit with built-in BMS. Ideal for homes and SMEs.',
    specs: {
      'Capacity': '10.24 kWh',
      'Chemistry': 'LiFePO₄',
      'Voltage': '48 V / 200 Ah',
